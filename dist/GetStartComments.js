class GetStartComments {
    drawStartComments() {
        ...
        for (let i = 0; i <= 2; i++) {
            ...
            const newLikeLocalStorage = Number(localStorage.getItem(`newLike${divCommentPeople.getAttribute("data-index")}`));
            const likeLocalStorage = Number(localStorage.getItem(`like${divCommentPeople.getAttribute("data-index")}`));
